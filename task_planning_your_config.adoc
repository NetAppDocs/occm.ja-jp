...
https://docs.netapp.com/us-en/cloud-volumes-ontap/reference_configs_aws_98.html["Cloud Volumes ONTAP 9.8 で AWS でサポートされる構成"^]
...
https://docs.netapp.com/us-en/cloud-volumes-ontap/reference_limits_aws_98.html["Cloud Volumes ONTAP 9.8 での AWS でのストレージの制限"]
