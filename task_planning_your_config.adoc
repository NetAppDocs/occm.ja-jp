...
https://docs.netapp.com/us-en/cloud-volumes-ontap/reference_configs_aws_990.html["AWS で Cloud Volumes ONTAP 9.9.0 のサポートされる構成"^]
...
https://docs.netapp.com/us-en/cloud-volumes-ontap/reference_limits_aws_990.html["AWS での Cloud Volumes ONTAP 9.9.0 のストレージの制限"^]
