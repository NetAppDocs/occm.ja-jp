...
https://docs.netapp.com/us-en/cloud-volumes-ontap/reference_configs_aws_990.html["Cloud Volumes ONTAP 9.8 で AWS でサポートされる構成"^]
...
https://docs.netapp.com/us-en/cloud-volumes-ontap/reference_limits_aws_990.html["Cloud Volumes ONTAP 9.8 での AWS でのストレージの制限"]
...
--
EBS ディスクタイプ:: 汎用 SSD （ gp2 ）は Cloud Volumes ONTAP で最も一般的なディスクタイプです。EBS ディスクのユースケースについては、を参照してください http://docs.aws.amazon.com/AWSEC2/latest/UserGuide/EBSVolumeTypes.html["AWS ドキュメント：「 EBS Volume Types"^]。
EBS ディスクサイズ::
+
--
