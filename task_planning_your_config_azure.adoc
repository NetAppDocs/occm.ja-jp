...
https://docs.netapp.com/us-en/cloud-volumes-ontap/reference_configs_azure_991.html["Azure で Cloud Volumes ONTAP 9.9.1 がサポートされる構成"^]
...
https://docs.netapp.com/us-en/cloud-volumes-ontap/reference_limits_azure_991.html["Azure での Cloud Volumes ONTAP 9.9.1 のストレージの制限"^]
