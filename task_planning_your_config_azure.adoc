...
https://docs.netapp.com/us-en/cloud-volumes-ontap/reference_configs_azure_990.html["Cloud Volumes ONTAP 9.8 で Azure でサポートされる構成"^]
...
https://docs.netapp.com/us-en/cloud-volumes-ontap/reference_limits_azure_990.html["Cloud Volumes ONTAP 9.8 の Azure のストレージ制限"]
