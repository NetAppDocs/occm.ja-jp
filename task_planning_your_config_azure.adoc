...
https://docs.netapp.com/us-en/cloud-volumes-ontap/reference_configs_azure_990.html["Azure で Cloud Volumes ONTAP 9.9.0 がサポートされる構成"^]
...
https://docs.netapp.com/us-en/cloud-volumes-ontap/reference_limits_azure_990.html["Azure での Cloud Volumes ONTAP 9.9.0 のストレージの制限"^]
