...
https://docs.netapp.com/us-en/cloud-volumes-ontap/reference_configs_aws_990.html["Cloud Volume が提供する Amazon EC2 インスタンスの詳細については、こちらをご覧ください ONTAP はをサポートします"^]。
...
https://docs.netapp.com/us-en/cloud-volumes-ontap/reference_configs_azure_990.html["Cloud Volume が提供する Azure VM の種類について詳しくは、こちらをご覧ください ONTAP はをサポートします"^]。
...
https://docs.netapp.com/us-en/cloud-volumes-ontap/reference_configs_gcp_990.html["Cloud の Google Cloud マシンタイプの詳細をご覧ください Volume ONTAP はをサポートします"^]。
