...
https://docs.netapp.com/us-en/cloud-volumes-ontap/reference_configs_gcp_990.html["GCP の Cloud Volumes ONTAP 9.9.0 でサポートされている構成"^]
...
https://docs.netapp.com/us-en/cloud-volumes-ontap/reference_limits_gcp_990.html["GCP の Cloud Volumes ONTAP 9.9.0 でのストレージの制限"^]
