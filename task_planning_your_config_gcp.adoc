...
https://docs.netapp.com/us-en/cloud-volumes-ontap/reference_configs_gcp_98.html["GCP の Cloud Volumes ONTAP 9.8 でサポートされている構成"^]
...
https://docs.netapp.com/us-en/cloud-volumes-ontap/reference_limits_gcp_98.html["GCP の Cloud Volumes ONTAP 9.8 でのストレージの制限"]
