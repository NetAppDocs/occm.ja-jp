...
* などの統合クラウドサービスやソフトウェアを有効にします https://cloud.netapp.com/cloud-compliance["クラウドデータの意味"^]、 https://cloud.netapp.com/cloud-insights["Cloud Insights の機能です"^]、 https://cloud.netapp.com/cloud-backup-service["Cloud Backup サービスの略"^]、 https://netapp.io/persistent-storage-provisioner-for-kubernetes/["Trident"^]など。
